...
// START: FOLLOWING BLOCK IS TO ENABLE WEAK CORS. THIS SOLUTION DOES NOT WORK FOR PRODUCTION!
...
- (nullable instancetype)initWithFrame:(CGRect)frame configuration:(nullable WKWebViewConfiguration *)configuration
{
    ...
    if (self) {
        ...
        // enable weak cors for testing app - this does not work for production
        WDBSetWebSecurityEnabled([configuration preferences], false);
    }
